...
const readEmployee = async (id) =>
{
	...
	if (!employee)
	{
		throw new ErrException(404, "error! Employee not found");
	}
	return employee;
};
...
const createEmployee = async (employeeBody) =>
{
	...
	if (!result)
	{
		throw new ErrException(500, "Couldn't create employee");
	}
	return result;
};
...
const deleteEmployee = async (id) =>
{
	...
	if (!result)
	{
		throw new ErrException(500, "Couldn't delete employee");
	}
	return result;
};
...
const updateEmployee = async (id, employeeBody) =>
{
	...
	if (!result)
	{
		throw new ErrException(500, "Couldn't update employee");
	}
